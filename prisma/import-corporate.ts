...
async function main() {
    const filePath = path.join(process.cwd(), 'corporate.json');
    ...
    try {
        ...
        console.log(`Found ${rawQuestions.length} Corporate Finance questions to import.`);
        ...
        for (let i = 0; i < rawQuestions.length; i++) {
            ...
            // Target topic ID is 'corporate'
            const targetTopicId = 'corporate';
        ...
        console.log('Corporate Finance import successful!');
    } catch (error) {
        console.error('Failed to parse or import Corporate Finance questions:', error);
    }
}
